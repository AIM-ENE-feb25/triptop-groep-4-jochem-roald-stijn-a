...
public class BookingComAdapter implements IBookingAdapter {
    ...
    public Hotel[] searchHotels(String location, String checkInDate, String checkOutDate) {
        ...
        String url = "https://booking-com15.p.rapidapi.com/api/v1/hotels/searchHotels?dest_id=" + dest_id + "&search_type=CITY&arrival_date=" + checkInDate + "&departure_date=" + checkOutDate + "&adults=1&children_age=0%2C17&room_qty=1&page_number=1&units=metric&temperature_unit=c&languagecode=en-us&currency_code=EUR&location=US";
